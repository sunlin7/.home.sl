;;; sl-cpp-root.el --- extern the ede-cpp-root-project slot -*- lexical-binding:t -*-
;;; Commentary:
;;; Code:
...
(cl-defmethod initialize-instance ((_ sl-ede-cpp-root-project)
                                   &rest _)
