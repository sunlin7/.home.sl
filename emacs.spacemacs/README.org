...
#+begin_src emacs-lisp :tangle ".emacs/init.el"
  ...
  (define-advice spacemacs/write-custom-settings-to-dotfile (:around (&rest))) ; use settings from current file
  ...
  (setq dired-guess-shell-gnutar "tar" ; avoiding their initilize forms call external-bin
        tramp-repository-branch nil
        tramp-repository-version nil)
  (custom-set-variables '(spacemacs-theme-custom-colors '((act2 . "#333333")(border . "#000000")(comp . "#646175"))))

  (custom-set-variables '(helm-exit-idle-delay 0.1))
  ...
  (custom-set-variables                   ; variables after loading Spacemacs
   ...
   '(window-system-default-frame-alist
     '((x . ((left . 0) (top . 72) (width . 190) (height . 50)))
       (w32 . ((left . (+ -16)) (top . (+ -3)) (width . 191) (height . 54))))))
  ...
  (with-eval-after-load "thingatpt" ; let ffap support `@<path>' and `layers/+<name>/<path>'
    (define-thing-chars filename (concat (delete ?@ thing-at-point-file-name-chars) "+")))
